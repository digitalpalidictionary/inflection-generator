...
const changedInflections = require('./output/changed inflections.json')
const fs = require('fs')
...
fs.writeFile("output/changed inflections translit.json", justInflectionsJson, function (err) {
	if (err) {
